...
const elements = {
    ...
    generateReceiptBtn: document.getElementById("generateReceipt") as HTMLButtonElement | null,
    ...
    payerCpfCnpjInput: document.getElementById("payerCpfCnpj") as HTMLInputElement,
    beneficiaryCpfCnpjInput: document.getElementById("beneficiaryCpfCnpj") as HTMLInputElement,
    payerErrorDisplay: document.getElementById("payerCpfCnpjError") as HTMLParagraphElement,
    beneficiaryErrorDisplay: document.getElementById("beneficiaryCpfCnpjError") as HTMLParagraphElement,
    receiptDateInput: document.getElementById("receiptDate") as HTMLInputElement,
    receiptNumberInput: document.getElementById("receiptNumber") as HTMLInputElement,
    ...
    beneficiaryNameInput: document.getElementById("beneficiaryName") as HTMLInputElement,
    beneficiaryStateInput: document.getElementById("beneficiaryState") as HTMLSelectElement,
    observationsInput: document.getElementById("observations") as HTMLTextAreaElement,
...
function initializeForm(): void {
    ...
    if (elements.generateReceiptBtn && elements.generateReceiptBtn.form) {
        elements.generateReceiptBtn.form.addEventListener("submit", (event: Event) => {
...
function setupCpfCnpjValidation(input: HTMLInputElement, errorDisplay: HTMLParagraphElement) {
...
function addItem() {
    ...
    if (container && templateElement instanceof HTMLTemplateElement) {
        const templateContent = templateElement.content.cloneNode(true) as DocumentFragment;
        const newItem = templateContent.querySelector(".serviceItem") as HTMLElement | null;
        ...
        if (newItem) {
            ...
            const descriptionInput = newItem.querySelector('input[name="description"]') as HTMLInputElement | null;
            const totalLabel = newItem.querySelector('label[for="total"]');
            const totalInput = newItem.querySelector('input[name="total"]') as HTMLInputElement | null;
            const removeButton = newItem.querySelector(".removeItemBtn") as HTMLButtonElement | null;
...
function collectFormData(): ReceiptData {
    ...
    function collectServiceItems(): ServiceItem[] {
        ...
        document.querySelectorAll(".serviceItem").forEach((itemElement) => {
            const descriptionInput = itemElement.querySelector('[name^="description"]') as HTMLInputElement;
            const totalInput = itemElement.querySelector('[name^="total"]') as HTMLInputElement;
...
function updateServiceItemsDisplay(data: ReceiptData) {
    ...
    const templateElement = document.getElementById("outputServiceItemTemplate") as HTMLTemplateElement;
    if (!templateElement) {
        return;
    }
    ...
    data.serviceItems.forEach((item) => {
        ...
        if (newItem) {
            const descriptionP = newItem.querySelector(".outputItemDescription") as HTMLParagraphElement;
            const totalP = newItem.querySelector(".outputItemTotal") as HTMLParagraphElement;
...
function calculateTotal() {
    ...
    document.querySelectorAll(".serviceItem").forEach((item) => {
        const totalInput = item.querySelector('[name^="total"]') as HTMLInputElement;
        if (totalInput) {
